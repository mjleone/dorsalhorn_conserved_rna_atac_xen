...
PathToNarrowPeak="/projects/pfenninggroup/singleCell/Macaque_SealDorsalHorn_snATAC-seq/data/raw_data/halper/*Mus_musculusToHomo_sapiens.HALPER.narrowPeak.gz"
